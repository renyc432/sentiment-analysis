...
# XGBoost: explore the algorithm
from xgboost import XGBClassifier

# what's learning_rate
xgb_bag = XGBClassifier(random_state=22,learning_rate=0.9)
...
xgb_tfidf = XGBClassifier(random_state=22,learning_rate=0.9)
